...
unsigned int  _g_fin_bitmask     = 0;
unsigned int  _g_fiber_bitmask   = 0;

string         _g_loopbacks_requested = "";
unsigned int   _g_loopback_mask      = 0;
...
unsigned int   _g_threshold_scan_low_limit         = 1310;
unsigned int   _g_threshold_scan_high_limit        = 2620;
unsigned int   _g_threshold_scan_step_size         = 10;
...
const u_int32_t _g_packet_header                       = 0x00be11e2;
const u_int32_t _g_protocol_freeze_date                = 0x20111213;
const u_int32_t _g_packet_footer                       = 0x62504944;
const u_int32_t _g_packet_type[NUMBER_OF_PACKET_TYPES] = { 0x00c0ffee, 
							   0x0000eada, 
							   0x000f00da, 
							   0x000ab0de, 
							   0xce11b10c };
u_int32_t       _g_packet[NUMBER_OF_WORDS_IN_A_PACKET];
