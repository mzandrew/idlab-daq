...
#define NUM_PACKET_QEV (132)		//# of packets in QEV (132)
...
//------------RX
extern tDMA_descriptor DMA_PPI0[2];
...
//------------TX
extern tDMA_descriptor DMA_PPI1[2];
...
extern volatile unsigned int buffer32[SIZE_QEV/2];
