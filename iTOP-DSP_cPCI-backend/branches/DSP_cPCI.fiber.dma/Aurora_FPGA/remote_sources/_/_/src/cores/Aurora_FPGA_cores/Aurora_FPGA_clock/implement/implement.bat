...
xst -ifn xst.scr
copy Aurora_FPGA_clock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\Aurora_FPGA_clock.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Aurora_FPGA_clock.ucf Aurora_FPGA_clock_exdes

echo 'Running map'
map -timing -pr b Aurora_FPGA_clock_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -tm Aurora_FPGA_clock_exdes -w routed.ncd routed.v
cd ..
