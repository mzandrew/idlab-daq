...
COPY Aurora_GTP_transceiver_top.edf .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\Aurora_GTP_transceiver_top.ucf -p xc6slx45t-fgg484-3 Aurora_GTP_transceiver_top.edf Aurora_GTP_transceiver_top.ngd
...
ECHO 'Running NGD'
map -register_duplication on -global_opt speed -logic_opt on -retiming on -timing -ol high -w -p xc6slx45t-fgg484-3 -o mapped.ncd Aurora_GTP_transceiver_top.ngd
