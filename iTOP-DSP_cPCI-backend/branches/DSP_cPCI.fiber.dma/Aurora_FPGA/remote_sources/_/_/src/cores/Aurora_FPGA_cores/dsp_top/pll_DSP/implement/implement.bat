...
xst -ifn xst.scr
move pll_DSP_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\pll_DSP.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll_DSP.ucf pll_DSP_exdes

echo 'Running map'
map -timing -pr b pll_DSP_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pll_DSP_exdes -w routed.ncd routed.v
cd ..
