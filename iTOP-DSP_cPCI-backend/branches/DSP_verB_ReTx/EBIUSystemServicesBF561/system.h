...
#ifdef FPGA_OFF
extern unsigned short int waveform_buf[NN];
extern unsigned short int waveform_split[N];
extern unsigned short int x_t[N];
extern unsigned short int x_T[N];
#endif
...
typedef struct DMA_descriptor_str {
	struct DMA_descriptor_str *ptrNext;
	void *startAddress;
}DMA_descriptor_large;
...
extern DMA_descriptor_large dma_descriptor_Tx[number_of_blocks];
//extern struct dma_descriptor_struct dma_descriptor_Tx[number_of_blocks];
extern unsigned short int buffer1[number_of_blocks][NN];
